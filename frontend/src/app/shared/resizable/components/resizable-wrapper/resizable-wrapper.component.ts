...
@Component({
  ...
  host: {
    '(document:mousemove)': 'onCornerMove($event)',
    '(document:mouseup)': 'onCornerRelease()'
  },
  imports: [],
...
export class ResizableWrapperComponent {
  ...
  private readonly $clampedDimensionsComputed: Signal<Dimensions> = computed<Dimensions>(() => {
  ...
  protected onCornerRelease(): void {
