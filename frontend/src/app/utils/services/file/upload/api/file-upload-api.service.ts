...
export class FileUploadApiService {
  ...
  public getFiles$(fileNames: string[], type?: string): Observable<Blob | undefined> {
  ...
  public getFile$(fileName: string, type?: string): Observable<Blob | undefined> {
    switch (type) {
      case "card-face":
  ...
  public replaceFilePath$(fileName: string, type?: string): Observable<{ id: string | undefined; }> {
    switch (type) {
      case "card-face":
  ...
  public replaceFilePaths$(fileNames: string[], type?: string): Observable<string[]> {
    switch (type) {
      case "card-face":
  ...
  public uploadFile$(formData: FormData, type?: string): Observable<{ id: string }> {
  ...
  public uploadFiles$(formData: FormData, type?: string): Observable<string[]> {
    switch (type) {
      case "card-face":
  ...
  public replaceFile(formData: FormData, fileName: string, type?: string): Observable<{
    id: string;
  }> {
    switch (type) {
      case "card-face":
