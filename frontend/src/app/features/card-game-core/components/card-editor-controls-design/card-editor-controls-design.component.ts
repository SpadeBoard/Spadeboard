...
@Component({
  ...
  imports: [CardEditorControlsDesignCardsTemplateContainerComponent, CardEditorControlsCardFaceElementsListComponent, CardFaceRteComponent, CardEditorControlsElementAttributesComponent],
