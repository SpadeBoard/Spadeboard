...
import { DEFAULT_CARD_EDITOR_FACE_PREVIEW_CELL_SIZE } from '../../../card-editor-face/constants/card-editor-face.constants';
...
export class CardFaceElementDndService {
  ...
  // Converts an absolute point on the page into coordinates relative to a rectangle
