...
import { DEFAULT_CARD_FACE_BACKGROUND_COLOR, DEFAULT_CARD_FACE_BORDER_COLOR, DEFAULT_CARD_FACE_BORDER_RADIUS, DEFAULT_CARD_FACE_BORDER_WIDTH, DEFAULT_CARD_FACE_HEIGHT, DEFAULT_CARD_FACE_WIDTH } from '../../../../../../card-editor/constants/card-editor.constants';

@Injectable({
  providedIn: 'root'
})
export class CardFaceAttributesControlsService {
  ...
  public setCardFaceAttributes(cardFace: CardFace): {
    cardFaceId: string,
    cardFaceDimensions: Dimensions,
    cardFaceHexcode: string,
    cardFaceHexInput: string,
    borderHexcode: string,
    borderHexInput: string,
    borderDimensions: BorderDimensions,
    borderRadius: number
  } {
    let currentCardFace: CardFace = cardFace;
    ...
    return {
      cardFaceId: this.$cardFaceId(),
      cardFaceDimensions: this.cardFaceDimensions,
      cardFaceHexcode: this.cardFaceHexcode,
      cardFaceHexInput: this.cardFaceHexInput,
      borderHexcode: this.borderHexcode,
      borderHexInput: this.borderHexInput,
      borderDimensions: this.borderDimensions,
