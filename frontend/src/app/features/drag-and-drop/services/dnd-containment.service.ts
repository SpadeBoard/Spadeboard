...
export class DndContainmentService {
  ...
  public getContaineesFromContainer(container: any): any[] {
  ...
  public getContainerFromContainee(containee: any, container: any[]): any {
  ...
  // TODO: This should probably be used with retrieving data from the backend
  public getContainerFromContainees(): any {
